      ...
      <div className="historyAgency_cont_content row">
        ...
        <div className="historyAgency_cont_content_bottom">
          ...
          <div className="detail_text row">
            <p className="col-6">
              Торжественное открытие нашего нового офиса в Бишкеке знаменует
              собой важную веху на нашем пути как ведущей строительной компании.
            </p>
            <p className="col-6">
              Наш новый офис оснащён самым современным оборудованием и
              укомплектован преданной своему делу командой профессионалов,
              стремящихся предоставлять исключительные строительные услуги.{" "}
            </p>
          </div>
        </div>
      </div>
