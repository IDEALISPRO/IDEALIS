...
import { getHotDeals } from "../../../app/store/reducers/admin/news/newsThunk";

export const HotOffers = () => {
  const { hotDeals: cards, loading, error } = useNews();
  ...
  //       descriptionSecond:
  //         "Успейте выбрать квартиру, дом или коммерческое помещение по выгодной цене. Мы собрали самые актуальные и привлекательные предложения на рынке.",
  //     },
  //     {
  //       id: 3,
  //       image: img3,
